...
echo "******************************************************************"
echo "*************************************************************************"
echo " This program is modified by RoboCIn"
echo " Copyright 2019, Cristiano Oliveira, Mateus Gonçalves, Walber Rodrigues"
echo " Centro de Informática - Universidade Federal de Pernambuco, Brazil"
